...
URL="https://_._._._:8080/ssrv-war/"   # URL адрес приложения
...
DB_CM5="bd_1"    # Полное название базы данных CM5
DB_CMJ="bd_2"    # Полное название базы данных CMJ
DB_USER="..."        # Имя пользователя для доступа к базе данных
DB_PASSWORD="..."    # Пороль пользователя для доступа к базе данных
DB_HOST="_._._._"    # Адрес сервера баз данных
